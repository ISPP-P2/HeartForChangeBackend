...
public class WorkshopControllerTest {
	...
	public void createWorkshopTest() throws OperationNotAllowedException {
		...
		when(taskService.saveTaller("oken", taskDTO)).thenReturn(taskDTO);
		HttpServletRequest request = mock(HttpServletRequest.class);
		when(request.getHeader("Authorization")).thenReturn("Bearertoken");

		ResponseEntity<?> res = workshopController.save(request, taskDTO);
	...
	public void getTaskByIdTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getTaskById(request, 1L);
		assertEquals(res, ResponseEntity.ok(taskDTO));
	}
	...
	public void getByOngTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getByOng(request);
	...
	public void updateTest() throws OperationNotAllowedException {
		...
		TaskDTO  taskDTO = new TaskDTO(task);
		when(jwtUtils.validateJwtToken("oken")).thenReturn(true);
		when(taskService.updateTaller("oken", 1L, taskDTO)).thenReturn(taskDTO);
		HttpServletRequest request = mock(HttpServletRequest.class);
		when(request.getHeader("Authorization")).thenReturn("Bearertoken");

		ResponseEntity<?> res = workshopController.update(request, taskDTO, 1L);
		assertEquals(res, ResponseEntity.ok(taskDTO));
	}
	...
	public void deleteTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.deleteWorkshop(1L, request);
		assertEquals(res, ResponseEntity.ok("Workshop deleted"));
	}
	...
	public void getBeneficiariesByIdTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getBeneficiariesById(request, 1L);
		assertEquals(res, ResponseEntity.ok(lista));
	}
	...
	public void getAttendancesByIdTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getAttendancesById(request, 1L);
		assertEquals(res, ResponseEntity.ok(lista));
	}
	...
	public void getStatePetitionByOngTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getStatePetitionByONG(request, 1L, 1L);
	...
	public void getAttendancesByPersonIdTest() throws OperationNotAllowedException {
		...
		ResponseEntity<?> res = workshopController.getAttendancesByPersonId(request, 1L);
		assertEquals(res, ResponseEntity.ok(lista));
	}
